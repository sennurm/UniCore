...
| TC-AUTH-027 | Role CSV errors are per-row | Negative | P0 | CSV naming an unknown user, an unknown role and a bad org path | Upload | Valid rows applied; three rows rejected with reasons; batch not aborted | AUTH-FR-20 |
